  ...
  return (
    <main className="flex justify-center mt-36">
      <div className="flex flex-col items-center justify-center w-11/12 gap-20 xl:w-4/6 xl:flex-row">
                  ...
                  <Form>
                    ...
                    <div className="flex flex-row items-center justify-between mt-10 text-lg">
                      <div className="flex items-center">
                        <Field id="isRemember" type="checkbox" name="isRemember" className="w-4 h-4 mb-1 ation-100 r-1" />
        ...
        <Image className="w-11/12 lg:w-2/3 xl:w-1/2 animate__animated animate__fadeInRight" src={UndrawSecureLogin} />
      </div>
    </main>
  );
};
